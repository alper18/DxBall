package com.example.riad.dxball;
...
class GameCanvas extends View{
    ...
    protected void onDraw(final Canvas canvas)
    {
        ...
        if(_count <= 1)
        {
            ...
            canvas.drawText("Move Bar And Tap to Start",canvas.getWidth()/3-canvas.getWidth()/2+80,canvas.getHeight()/2+canvas.getHeight()/8, _paint);
        }
